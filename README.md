...
<p align="center">
  <strong>QQ 音乐与网易云音乐扫码连接</strong> ·
  <strong>按氛围或风格编排</strong> ·
  <strong>AI 主持人口播</strong> ·
  <strong>网页播放</strong>
</p>
...
OpenMusicRadio 会根据你在 QQ 音乐或网易云音乐里的收藏和听歌习惯，生成一档 30 到 120 分钟的私人音乐节目。

想听熟悉的歌，可以让节目多放一些自己喜欢过的作品。想换换口味，也可以选择多点探索，从符合当前氛围或指定风格的歌单里找到还没听过的音乐。歌曲会按照整档节目的情绪和节奏重新编排，并优先贴近选定时长，不会为了凑熟悉歌曲比例而明显拉长节目。

你可以按音乐氛围选歌，也可以直接指定喜欢的风格。放松、专注、运动、通勤和派对都有各自的编排方式。

每档节目会在音乐账号中创建一个临时歌单，名称统一采用 `OMR电台-XXXX`。后四个字根据本次氛围或所选风格概括生成，并避开账号里已经存在的同名歌单。节目结束后可以选择保留或删除。

## 六位主持人

节目提供六位拥有不同声音和表达方式的主持人。有人安静细腻，有人清爽直接，也有人更适合热闹、有活力的节目。

主持人会自然地介绍音乐人、歌曲风格、发行与专辑信息、公开奖项以及经典作品背后的故事。熟悉的歌会简短带过，值得认识的新歌会多讲一点。

用户确认最终歌单并启动节目后，系统才会确定整档节目的口播位置，再按照节目顺序一次生成一条。全部初稿完成后统一审核；通过的口播立即锁定，只把明确不合格的条目退回单独修改。这个准备过程不会展示口播文稿。开启桌面陪伴后，主持人还会以像素角色出现在桌面上，平时安静陪伴，口播时才开口说话。
...
3. 查看生成的歌单名称、歌曲顺序与全部口播，按需要调整歌曲或顺序。
4. 确认后开始播放。
