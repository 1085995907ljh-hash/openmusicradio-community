...
// Keep the music bed behind speech without burying it. This is an amplitude
// gain, so -10 dB leaves about 31.6% of the original music level.
export const HOST_MUSIC_DUCK_DB = -10;
